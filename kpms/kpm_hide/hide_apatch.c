...
/* Generic: excluded 鈫?original kernel, otherwise 鈫?KP hook chain */
...
/* For fstatat/faccessat/statx: also intercept /debug_ramdisk 鈫?-ENOENT */
